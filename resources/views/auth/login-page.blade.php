					...
					<div class="col-lg-5">
						<div
							...
							<div class="bg-overlay-img">
								<img src="{{ asset('img/bg/bg-01.png') }}" class="bg-1" alt="Img">
								<img src="{{ asset('img/bg/bg-02.png') }}" class="bg-2" alt="Img">
								<img src="{{ asset('img/bg/bg-03.png') }}" class="bg-3" alt="Img">
							</div>
					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap">
							...
							<div class="col-md-7 mx-auto vh-100">
								...
								<form action="{{ route('login') }}" class="vh-100" method="post">
									@csrf
